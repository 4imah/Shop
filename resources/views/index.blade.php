                    ...
                    <div class="row">
                        <div class="col-xl-2 col-lg-3 col-md-4 col-sm-4 col-5">
                            <div class="logo pt-39">
                                <a href="/"><img alt="" src="/img/logo/logo.png"></a>
                            </div>
                        </div>
                            ...
                            <div class="main-menu text-center">
                                <nav>
                                    <ul>
                                        ...
                                        <li class="mega-menu-position"><a href="shopPage">Food</a>
                                            <ul class="mega-menu">
                                                <li>
                                                    <ul>
                                                        <li class="mega-menu-title">Dogs Food</li>
                                                        <li><a href="/dogs_food/">Eggs</a></li>
                                                        <li><a href="shopPage">Carrots</a></li>
                                                        <li><a href="shopPage">Salmon fishs</a></li>
                                                        <li><a href="shopPage">Peanut Butter</a></li>
                                                        <li><a href="shopPage">Grapes & Raisins</a></li>
                                                    </ul>
                                                </li>
                                                <li>
                                                    <ul>
                                                        <li class="mega-menu-title">Cats Food</li>
                                                        <li><a href="shopPage">Meat</a></li>
                                                        <li><a href="shopPage">Fish</a></li>
                                                        <li><a href="shopPage">Eggs</a></li>
                                                        <li><a href="shopPage">Veggies</a></li>
                                                        <li><a href="shopPage">Cheese</a></li>
                                                    </ul>
                                                </li>
                                                <li>
                                                    <ul>
                                                        <li class="mega-menu-title">Fishs Food</li>
                                                        <li><a href="shopPage">Rice</a></li>
                                                        <li><a href="shopPage">Veggies</a></li>
                                                        <li><a href="shopPage">Cheese</a></li>
                                                        <li><a href="shopPage">wheat bran</a></li>
                                                        <li><a href="shopPage">Cultivation</a></li>
                                                    </ul>
                                                </li>
                                                <li>
                                                    <ul>
                                                        <li><a href="shopPage"><img alt="" src="/img/banner/menu-img-4.jpg"></a></li>
                                                    </ul>
                                                </li>
                                            </ul>
                                        </li>
                                        ...
                                        <li><a href="#">Food</a>
                                            <ul>
                                                <li><a href="#">Dogs Food</a>
                                                    <ul>
                                                        <li><a href="shopPage">Grapes and Raisins</a></li>
                                                        <li><a href="shopPage">Carrots</a></li>
                                                        <li><a href="shopPage">Peanut Butter</a></li>
                                                        <li><a href="shopPage">Salmon fishs</a></li>
                                                        <li><a href="shopPage">Eggs</a></li>
                            ...
                            <div class="col-lg-6 col-md-6 col-12 col-sm-7">
                                <div class="slider-content slider-animated-1 pt-114">
                                    ...
                                    <div class="slider-btn">
                                        <a class="animated" href="shopPage">SHOP NOW</a>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-6 col-md-6 col-12 col-sm-5">
                                <div class="slider-single-img slider-animated-1">
                                    <img class="animated" src="/img/slider/wolf-clip-art-48.png" alt="">
                                </div>
                            </div>
                        </div>
                    </div>
